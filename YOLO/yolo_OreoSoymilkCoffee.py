...
net = cv2.dnn.readNetFromDarknet("./project1101/yolov4.cfg", "./project1101/weights/yolov4_3000.weights")
...
# 讀取類別名稱
classes = [line.strip() for line in open("./project1101/obj.names")]
# 設定類別顏色
...
cap = cv2.VideoCapture('IMG_7489.MOV')
